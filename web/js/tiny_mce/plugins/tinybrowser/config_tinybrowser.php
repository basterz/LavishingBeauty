...
$tinybrowser['obfuscate'] = 'id5r79jf92843jfidf943j';
...
$tinybrowser['link']['image'] = '/uploads/assets/images/'; // Image links
$tinybrowser['link']['media'] = '/uploads/assets/media/'; // Media links
$tinybrowser['link']['file']  = '/uploads/assets/files/'; // Other file links
...
$tinybrowser['filetype']['media'] = '*.swf, *.dcr, *.mov, *.qt, *.mpg, *.mp3, *.mp4, *.mpeg, *.avi, *.wmv, *.wm, *.asf, *.asx, *.wmx, *.wvx, *.rm, *.ra, *.ram, *.flv'; // Media file types
$tinybrowser['filetype']['file']  = '*.*'; // Other file types

// Prohibited file extensions
$tinybrowser['prohibited'] = array('php3','php4','php5','phtml','asp','aspx','ascx','jsp','cfm','cfc','pl','bat','exe','dll','reg','cgi', 'sh', 'py','asa','asax','config','com','inc','ctp');
