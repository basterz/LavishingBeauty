...
abstract class BaseArticleForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'popular'    => new sfWidgetFormInputCheckbox(),
      'position'   => new sfWidgetFormInputText(),
      'viewed'     => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'popular'    => new sfValidatorBoolean(array('required' => false)),
      'position'   => new sfValidatorInteger(array('required' => false)),
      'viewed'     => new sfValidatorInteger(array('required' => false)),
