...
class ArticleForm extends BaseArticleForm
{
  public function configure() {
    ...
    public function doSave($con = null) {
        ...
        $resize_dimentions = sfConfig::get('app_article_thumb_image');
        $filepath = sfConfig::get('sf_upload_dir') . '/articles/' . $this->getObject()->getImage();
        ...
        $filepath = sfConfig::get('sf_upload_dir') . '/articles/' . $this->getObject()->getBigImage();
        $this->adaptiveResizeImage($filepath, $resize_dimentions, $image_field);
        return $response;
